...
urlpatterns = patterns('',
    ...
    url(r'^gmao/restricted/deny_news/(.*)/$', 'groupsite.views.deny_news'),
    #url(r'^gmao/restricted/authorize_science/(.*)/$', 'groupsite.views.auth_post'),
    #url(r'^gmao/restricted/deny_science/(.*)/$', 'groupsite.views.deny_post'),
