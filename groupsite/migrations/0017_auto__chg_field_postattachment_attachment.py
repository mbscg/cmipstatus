...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostAttachment.attachment'
        db.alter_column('groupsite_postattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'PostAttachment.attachment'
        db.alter_column('groupsite_postattachment', 'attachment', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))
