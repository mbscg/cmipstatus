...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsAttachment.attachment'
        db.alter_column('groupsite_newsattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'NewsAttachment.attachment'
        db.alter_column('groupsite_newsattachment', 'attachment', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))
