...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkInfo.twitter'
        db.add_column('groupsite_networkinfo', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'NetworkInfo.linkedin'
        db.add_column('groupsite_networkinfo', 'linkedin',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'NetworkInfo.google_plus'
        db.add_column('groupsite_networkinfo', 'google_plus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'NetworkInfo.facebook'
        db.add_column('groupsite_networkinfo', 'facebook',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkInfo.twitter'
        db.delete_column('groupsite_networkinfo', 'twitter')

        # Deleting field 'NetworkInfo.linkedin'
        db.delete_column('groupsite_networkinfo', 'linkedin')

        # Deleting field 'NetworkInfo.google_plus'
        db.delete_column('groupsite_networkinfo', 'google_plus')

        # Deleting field 'NetworkInfo.facebook'
        db.delete_column('groupsite_networkinfo', 'facebook')
