...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.besm'
        db.add_column('groupsite_post', 'besm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Publication.besm'
        db.add_column('groupsite_publication', 'besm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'News.besm'
        db.add_column('groupsite_news', 'besm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ScienceThing.besm'
        db.add_column('groupsite_sciencething', 'besm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.besm'
        db.delete_column('groupsite_post', 'besm')

        # Deleting field 'Publication.besm'
        db.delete_column('groupsite_publication', 'besm')

        # Deleting field 'News.besm'
        db.delete_column('groupsite_news', 'besm')

        # Deleting field 'ScienceThing.besm'
        db.delete_column('groupsite_sciencething', 'besm')
