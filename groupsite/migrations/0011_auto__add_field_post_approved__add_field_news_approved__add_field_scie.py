...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('groupsite_post', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'News.approved'
        db.add_column('groupsite_news', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ScienceThing.approved'
        db.add_column('groupsite_sciencething', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('groupsite_post', 'approved')

        # Deleting field 'News.approved'
        db.delete_column('groupsite_news', 'approved')

        # Deleting field 'ScienceThing.approved'
        db.delete_column('groupsite_sciencething', 'approved')
