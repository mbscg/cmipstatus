...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LattesCache.last_update'
        db.add_column('groupsite_lattescache', 'last_update',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2012, 7, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LattesCache.last_update'
        db.delete_column('groupsite_lattescache', 'last_update')
