...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostAttachment.description'
        db.alter_column('groupsite_postattachment', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'NewsImg.description'
        db.alter_column('groupsite_newsimg', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'NewsAttachment.description'
        db.alter_column('groupsite_newsattachment', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PostImg.description'
        db.alter_column('groupsite_postimg', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'PostAttachment.description'
        db.alter_column('groupsite_postattachment', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'NewsImg.description'
        db.alter_column('groupsite_newsimg', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'NewsAttachment.description'
        db.alter_column('groupsite_newsattachment', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'PostImg.description'
        db.alter_column('groupsite_postimg', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))
