...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.using_markdown'
        db.add_column('groupsite_post', 'using_markdown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.using_markdown'
        db.delete_column('groupsite_post', 'using_markdown')
