...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberConfig.compare_to'
        db.add_column('expwatch_memberconfig', 'compare_to',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberConfig.compare_to'
        db.delete_column('expwatch_memberconfig', 'compare_to')
