...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MemberConfig.last_req'
        db.delete_column('expwatch_memberconfig', 'last_req')

        # Adding field 'MemberConfig.last_gen'
        db.add_column('expwatch_memberconfig', 'last_gen',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MemberConfig.last_req'
        db.add_column('expwatch_memberconfig', 'last_req',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10),
                      keep_default=False)

        # Deleting field 'MemberConfig.last_gen'
        db.delete_column('expwatch_memberconfig', 'last_gen')
