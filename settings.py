# Django settings for inpe project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'inpedb.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&irn2ajanb3n+ikb+q@&#m&19h8pv!yy0-oh(6)r6ufkor=kxk'
